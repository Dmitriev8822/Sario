...
const CONFIG = {
  ...
  level: {
    blocks: [
      ...
      { x: 620, y: 277, w: 112, h: 18 },
      { x: 910, y: 277, w: 128, h: 18 },
      { x: 1210, y: 277, w: 116, h: 18 },
      { x: 1510, y: 277, w: 150, h: 18 },
      { x: 1840, y: 292, w: 128, h: 18 },
      { x: 2140, y: 277, w: 116, h: 18 },
      { x: 2440, y: 277, w: 132, h: 18 },
      { x: 2780, y: 277, w: 108, h: 18 },
      { x: 3090, y: 277, w: 150, h: 18 },
      { x: 3430, y: 286, w: 120, h: 18 },
      { x: 3740, y: 277, w: 132, h: 18 },
      { x: 4070, y: 277, w: 116, h: 18 },
      { x: 4380, y: 278, w: 154, h: 18 },
      { x: 4740, y: 277, w: 126, h: 18 },
      { x: 5070, y: 292, w: 114, h: 18 },
      { x: 5370, y: 277, w: 148, h: 18 },
      { x: 5710, y: 277, w: 122, h: 18 },
      { x: 6040, y: 277, w: 142, h: 18 },
      { x: 6380, y: 277, w: 120, h: 18 },
...
const FLOOR_Y = 324;
const MAX_JUMPABLE_BLOCK_HEIGHT = 88;
const PIXEL = 2;
const PALETTE = {
  ink: "#111827",
  sky1: "#60a5fa",
